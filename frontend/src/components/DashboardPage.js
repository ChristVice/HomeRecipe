...
function DashboardPage() {
  ...
  const isClicked = () => {
    console.log("this is a thingymabob");
  };
  ...
  return (
    <div className="dashboard-page">
      <div className="left-side-panel">
        ...
        <div className="">
          <div className="">
            ...
            {/* Logout Button */}
            <button className="logout-button" onClick={isClicked}>
              Logout
            </button>
          </div>
        </div>
      ...
      {/* Right Side Content */}
      <div className="right-side-panel">{/* Content for the right side */}</div>
    </div>
  );
